...
const kds_datepicker = {
	...
	close: () => { //datepicker 닫기
		...
		cal.forEach(e => {
			...
			// year, mon 클릭 후 달력 버튼 다시 클릭 시 css 겹침 현상 방지용 초기화 코드
			const tbl = e.querySelector('.datepicker-tbl-wrap');
			const year = e.querySelector('.datepicker-year-wrap');
			const mon = e.querySelector('.datepicker-mon-wrap');
